...
**AVVIO**
Una volta installato e attivato il Plugin **Shp2SSAP**, dall'icona ![Optional Text](../master/Image_readme/Shp2SSAP.png) della *toolbar plugins* o dalla omonima voce del menù *plugins* viene aperta una maschera multitab con tre TAB: *TAB XY → Vettoriale*, *Vettoriale → File SSAP* e *Opzioni*.
