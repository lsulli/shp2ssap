##**Qgis Plugin Shp2SSAP ver 2.0.8 (build 276)**##
...
6. [Caratteristiche vettoriale per SSAP](#car_shape)
7. [Upgrade](#upgrade)
8. [Bug fix](#bug_fix)
...
Latest File plugin: https://github.com/lsulli/shp2ssap/releases/download/v2.0.8/Shp2SSAP_QGIS-2.0.8.276.zip
