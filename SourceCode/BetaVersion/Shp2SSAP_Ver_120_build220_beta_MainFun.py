...
try:
    ...
    def check_function(pass_check,str_shape_path):
        """
        ...
        try:
            ...
            sf = shape_features(str_shape_path)
    ...
    def shp_2_ssap_files(str_shape_path,str_path_ssap):
        """
...
def open_form():
    try:
        if os.path.exists(xy2shp_forSSAP_str):
            ...
            proc = subprocess.Popen('.\\xy2Shp_forSSAP\\xy2Shp_forSSAP.exe', creationflags=subprocess.SW_HIDE, shell=True)
        else:
