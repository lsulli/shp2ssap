...
"""
xy2shp_forSSAP_093_020.py file sorgente per xy2Shp_forSSAP.exe ver 0.9.3 build 20
...
# history
# 2016.11.11 - Migliorato il codice per la sostituzione dei caratteri separatori di colonna, ora ammessi (; : | - )
