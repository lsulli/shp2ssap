...
"""
Shp2SSAP_Ver_117_build203.py file sorgente per Shp2SSAP.exe ver 1.1.7 build 205
...
# history
# - build 205 - 2018.03.14 - MATPLOTLIIB eliminato
...
#DA COORDINARE CON BUILD 204

try:
    import sys
    sys.path.insert(0, './moduli_py')
    from import_shp2ssap import *
except:
    print("Errore imprevisto importazione moduli") # temp message error: to edit

mtpl_chk = 0

# default value
xy2shp_forSSAP_str = "xy2Shp_forSSAP_093_021.py"
